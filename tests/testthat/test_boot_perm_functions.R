...
test_that("perm.events works good", {
  ...
  expect_equal( round(out.w1[1,1],7), 0.7856303)
  expect_equal( round(out.w2[1,1],7), 0.7686104)
  expect_equal( round(out.w3[1,1],5), 13.18834)
  expect_equal( round(out.b1[1,1],7), 0.8844048)
  expect_equal( round(out.b2[1,1],7), 0.8985246)
  expect_equal( round(out.b3[1,1],7), 0.04137931)
